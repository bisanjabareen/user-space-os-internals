#include "../include/sh2_malloc.h"
#include <stdio.h>

int main(void) {
    printf("=== SH2 Malloc Allocator Test Suite ===\n\n");
    
    printf("Test 1: Basic allocation\n");
    int *p1 = (int *)sh2_malloc(sizeof(int));
    if (p1 == NULL) {
    ...
    *p1 = 42;
    ...
    int *p2 = (int *)sh2_malloc(sizeof(int) * 10);
    char *p3 = (char *)sh2_malloc(100);
    double *p4 = (double *)sh2_malloc(sizeof(double) * 5);
    ...
    int *p5 = (int *)sh2_malloc(sizeof(int) * 5);
    if (p5 == NULL) {
